...
const D_ART={
 blue:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M8 34c13-18 35-18 48-2-8-2-15 0-20 6 9-2 17 1 20 7-15 4-31 0-48-11Z" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
 cyan:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 6v52M7 20l50 24M7 44l50-24M18 11l28 42M46 11 18 53" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round"/><circle cx="32" cy="32" r="5" fill="currentColor"/></svg>`,
 red:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M33 6c10 14 21 20 21 33 0 12-10 19-22 19S10 51 10 38c0-9 7-17 15-23 2 7 5 11 9 14-1-9-2-14-1-23Z" fill="currentColor"/></svg>`,
 green:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 7C18 18 12 30 15 42c3 11 14 17 25 14 9-3 14-11 10-20-3-6-8-8-13-10 2-5 1-11-5-19Z" fill="none" stroke="currentColor" stroke-width="5"/><path d="M42 24c4 1 8 4 10 8" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round"/></svg>`,
 yellow:`<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="32" r="18" fill="none" stroke="currentColor" stroke-width="5"/><path d="M32 5v11M32 48v11M5 32h11M48 32h11M13 13l8 8M43 43l8 8M51 13l-8 8M21 43l-8 8" stroke="currentColor" stroke-width="4" stroke-linecap="round"/></svg>`,
 pink:`<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="32" r="10" fill="currentColor"/><path d="M32 7v15M32 42v15M7 32h15M42 32h15M15 15l11 11M38 38l11 11M49 15 38 26M26 38 15 49" stroke="currentColor" stroke-width="5" stroke-linecap="round"/></svg>`,
 purple:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="m32 6 7 19 20 7-20 7-7 19-7-19-20-7 20-7 7-19Z" fill="none" stroke="currentColor" stroke-width="4" stroke-linejoin="round"/></svg>`,
 orange:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M36 5 12 36h16l-3 23 27-34H35L36 5Z" fill="currentColor"/></svg>`,
 black:`<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="32" r="22" fill="none" stroke="currentColor" stroke-width="5"/><circle cx="25" cy="27" r="3" fill="currentColor"/><circle cx="39" cy="27" r="3" fill="currentColor"/><path d="M22 41c7 5 13 5 20 0" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round"/></svg>`,
 white:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="m32 5 6 15 16 0-13 9 5 15-14-9-14 9 5-15-13-9 16 0 6-15Z" fill="none" stroke="currentColor" stroke-width="4" stroke-linejoin="round"/></svg>`,
 silver:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 6 50 13v16c0 13-7 22-18 29-11-7-18-16-18-29V13L32 6Z" fill="none" stroke="currentColor" stroke-width="5"/><path d="M23 32h18M32 23v18" stroke="currentColor" stroke-width="5" stroke-linecap="round"/></svg>`,
 gold:`<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="32" r="21" fill="none" stroke="currentColor" stroke-width="5"/><path d="M32 18v28M24 24c2-4 12-5 16 0-1 5-7 6-12 8-5 2-6 7-1 10 4 2 11 1 13-3" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round"/></svg>`,
 aqua:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M8 19c7-7 14-7 24 0s17 7 24 0M8 32c7-7 14-7 24 0s17 7 24 0M8 45c7-7 14-7 24 0s17 7 24 0" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round"/></svg>`,
 violet:`<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="32" r="22" fill="none" stroke="currentColor" stroke-width="5"/><circle cx="32" cy="32" r="7" fill="currentColor"/></svg>`,
 lime:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 57V28M32 35C21 35 14 28 14 17c10 0 18 7 18 18ZM32 43c11 0 18-7 18-18-10 0-18 7-18 18Z" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round" stroke-linejoin="round"/></svg>`,
 navy:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="m32 7 5 12 13 1-10 8 3 13-11-7-11 7 3-13-10-8 13-1 5-12Z" fill="none" stroke="currentColor" stroke-width="4"/><circle cx="32" cy="31" r="5" fill="currentColor"/></svg>`,
 coral:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 54c-10-9-19-16-19-27 0-7 5-12 11-12 4 0 7 2 8 5 2-3 5-5 9-5 6 0 11 5 11 12 0 11-9 18-20 27Z" fill="none" stroke="currentColor" stroke-width="5" stroke-linejoin="round"/><path d="M20 30c3 3 4 6 4 9M44 30c-3 3-4 6-4 9" stroke="currentColor" stroke-width="4" stroke-linecap="round"/></svg>`,
 mint:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 56V31M32 37C19 37 12 29 13 17c12 0 19 7 19 20ZM32 44c12 0 19-7 19-19-11 0-19 7-19 19Z" fill="none" stroke="currentColor" stroke-width="5" stroke-linecap="round"/></svg>`,
 rose:`<svg viewBox="0 0 64 64" aria-hidden="true"><circle cx="32" cy="31" r="13" fill="none" stroke="currentColor" stroke-width="5"/><path d="M22 20c-5-6-14-5-16 2 4 5 10 7 16 4M42 20c5-6 14-5 16 2-4 5-10 7-16 4M23 42c-3 8-11 12-17 8 0-7 5-12 12-13M41 42c3 8 11 12 17 8 0-7-5-12-12-13" fill="none" stroke="currentColor" stroke-width="4" stroke-linecap="round"/></svg>`,
 prism:`<svg viewBox="0 0 64 64" aria-hidden="true"><path d="M32 6 54 18 46 48 18 48 10 18 32 6Z" fill="none" stroke="currentColor" stroke-width="4"/><path d="M10 18h44M18 48 32 30 46 48M32 6v24" fill="none" stroke="currentColor" stroke-width="4"/></svg>`,
 cosmic:`<svg viewBox="0 0 64 64" aria-hidden="true"><ellipse cx="32" cy="32" rx="22" ry="9" fill="none" stroke="currentColor" stroke-width="4" transform="rotate(-25 32 32)"/><circle cx="32" cy="32" r="7" fill="currentColor"/><circle cx="13" cy="16" r="2.5" fill="currentColor"/><circle cx="51" cy="17" r="2.5" fill="currentColor"/></svg>`
};
...
function diceHTML(type,lvl=1,rank=1){const d=D[type]||D.blue;const safeRank=Math.max(1,Math.min(7,Number(rank)||1));const face=safeRank===7?`<div class="starMark">★</div>`:dicePips(safeRank);return `<div class="dice ${d.cls}" data-dice-type="${esc(type)}">${face}<span class="dieArt">${D_ART[type]||D_ART.blue}</span><small>Lv.${Math.max(1,Math.min(50,Number(lvl)||1))}</small></div>`;}

function battleDiceHTML(die,selected=false){const d=D[die.type]||D.blue,r=Math.max(1,Math.min(7,Number(die.rank)||1));const face=r>=7?`<div class="starMark">★</div>`:dicePips(r);return `<div class="dice battleDie ${d.cls} ${selected?'battleSelected':''}" title="${d.name} · ${r}성">${face}<span class="dieArt">${D_ART[die.type]||D_ART.blue}</span><small>${r>=7?'★ 7성':r+'성'}</small></div>`;}
...
function startBattle(){
 ...
 const title=mode==='battle'?'⚔️ 아레나':'🤝 협동전',sub=mode==='battle'?'각자의 길 · 먼저 기지 HP가 0이 되면 패배':'';
...
function getSpeedCap(){return appState.opponentType==='player'||appState.battle?.opponentType==='player'?1.5:1.5;}
function toggleSpeed(){const cap=getSpeedCap();appState.speed=appState.speed>=cap?1:Math.min(cap,appState.speed+0.5);if(appState.battle)appState.battle.opponentSpeed=appState.speed;sendBattle({type:'speed',speed:appState.speed});updateBattleHUD();}
...
function battleUpgradeHTML(){const types=[...new Set(appState.deck||[])].filter(Boolean);return types.map(type=>{const lv=Number(appState.battleDiceUpgrades?.[type]||0),cost=battleDieUpgradeCost(type),d=D[type]||D.blue;return `<div class="battleDieUpgradeCard"><div class="battleDieUpgradeImage">${diceHTML(type,appState.diceLevels?.[type]||1)}</div><b>${d.name}</b><small>현재 레벨 ${lv}/10</small><button class="battleDieUpgradeBtn" onclick="upgradeBattleDie('${type}')">업그레이드 · SP ${cost}</button></div>`}).join('');}
function setupBattle(){appState.sp=100;appState.battleDiceUpgrades={};appState.kills=0;appState.gameSec=0;appState.speed=1;appState.selected=null;appState.coopEnded=false;appState.killGoal=5000;appState.nextBossKill=150;appState.bossIndex=0;appState.myBossCount=0;appState.oppBossCount=0;appState.battleUpgradeLevel=0;appState.battleUpgradeDamage=0;appState.enemies=[];appState.oppEnemies=[];appState.sharedEnemies=[];appState.diceGrid=ensureBattleGrid([],'me');appState.battle.myBase=150;appState.battle.opponentBase=150;appState.battle.sharedBase=150;appState.battle.opponentSpeed=1;appState.battle.opponentDice=ensureBattleGrid([],'opp');last=0;lastAttack=0;lastOpponentAttack=0;appState._atk={};renderBattleDice();updateBattleHUD();for(let i=0;i<6;i++){setTimeout(()=>addEnemyFor('me'),i*260);setTimeout(()=>addEnemyFor(appState.battle.mode==='coop'?'shared':'opp'),i*260);}if(appState.opponentType==='player'&&appState.matchId)sendBattle({type:'battle_join',matchId:appState.matchId,grid:appState.diceGrid,speed:appState.speed,mode:appState.battle.mode});window.rd2BattleRaf=requestAnimationFrame(battleLoop);}
...
function loopBattleBots(dt){if(appState.opponentType==='ai'){if(!appState.battle.opponentDice.some(Boolean)&&Math.random()<dt*.9){const aiSlot=appState.battle.opponentDice.findIndex(d=>!d);if(aiSlot>=0)appState.battle.opponentDice[aiSlot]=randomBattleDie('ai');renderBattleDice();}appState.battle.opponentSpeed=appState.speed;const arr=appState.battle.mode==='coop'?appState.sharedEnemies:appState.oppEnemies;if(arr.length<Math.min(6+Math.floor(appState.kills/350),18)&&Math.random()<dt*(1+appState.kills/1800))addEnemyFor(appState.battle.mode==='coop'?'shared':'opp');if(appState.battle.mode==='coop'){const bossTarget=Math.floor(appState.kills/150);if(bossTarget>appState.oppBossCount){appState.oppBossCount=bossTarget;const count=Math.max(1,Math.min(1+Math.floor(appState.kills/750),6));for(let i=0;i<count;i++)setTimeout(()=>addEnemyFor('shared',true),i*260);}}}}
function dieDamage(die){const lobbyLv=Math.max(1,Math.min(50,Number(appState.diceLevels?.[die.type]||1))),rank=Math.max(1,Math.min(7,Number(die.rank)||1)),permanent=1+(lobbyLv-1)*.08,global=1+((appState.treeLevels?.allDamage||1)-1)*.05,battleLv=Math.max(0,Math.min(10,Number(appState.battleDiceUpgrades?.[die.type]||0))),battle=1+(battleLv*15)/100;return (D[die.type]?.damage||50)*permanent*(1+(rank-1)*.75)*global*battle;}
